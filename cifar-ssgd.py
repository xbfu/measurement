...
def get_accuracy(ps_rref, data_dir, test_batch_size, job_name, target):
...
def run(rank, num_workers, data_dir, model, batch_size, test_batch_size, lr, num_epochs, job_name, target):
    ...
    if rank == 0:
        ...
        futs.append(rpc.rpc_async(to="tester",
                                  func=get_accuracy,
                                  args=(ps_rref, data_dir, test_batch_size, job_name, target)))
