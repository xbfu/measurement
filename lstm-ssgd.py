...
class ParameterServer(object):
    def __init__(self, model, num_workers, lr, job_name):
        ...
        self.model = lstm.RNNModel(rnn_type='LSTM', ntoken=28782, ninp=200, nhid=200, nlayers=2, dropout=0)
        self.lr = lr
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train models on WikiText2 under SSGD")
    parser.add_argument("--job_name", type=str, default="test", help="The job's name.")
    parser.add_argument("--model", type=str, default="lstm", help="The model's name.")
